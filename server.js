...
var update = function() {
  ...
  fb.image(xMax / 2 - 16, yMax / 2 + radius * 0.50 - 16,
  ...
  fb.text(xMax / 2 + 16, yMax / 2 + radius * 0.50 + 16, now.toLocaleDateString(),
    true, 0); // Draw the text non-centered, rotated _a_ degrees
